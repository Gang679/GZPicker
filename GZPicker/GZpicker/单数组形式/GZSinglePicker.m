...
static CGFloat const PickerViewHeight = 180;
static CGFloat const PickerViewLabelWeight = 80;

@interface GZSinglePicker()<UIPickerViewDataSource, UIPickerViewDelegate>
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component
{
    ...
    if (component == 0) {
        return (GZScreenWidth-PickerViewLabelWeight)/2;
    }else if (component == 1){
...
{
    if (!_toolbar) {
        _toolbar = [[GZPickerToolbar alloc]initWithTitle:@" "
